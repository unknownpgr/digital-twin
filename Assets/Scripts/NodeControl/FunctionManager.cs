...
public class FunctionManager : MonoBehaviour
{
	...
	private void UpdateNodeInfoWindow()
	{
		...
		else if (selectedNode is NodeEarthquakeSensor nodeEarthquakeSensor)
		{
			nodeValue.text = nodeEarthquakeSensor.ValueEarthquake.ToString();
		}
		else if (selectedNode is NodeFloodSensor nodeFloodSensor)
		{
			nodeValue.text = nodeFloodSensor.ValueFlood.ToString();
		}
	}
