...
public class Grid3 : MonoBehaviour
{
    ...
    public Node3[] GetNodesFromLine(Vector3 _a, Vector3 _b)
    {
        ...
        Bresenham3D bres = new Bresenham3D(st, en);
    ...
    void SetLine(LineRenderer line, Color c, float size = 0.3f)
    {
        line.useWorldSpace = true;
        line.endColor = new Color(c.r, c.g, c.b, 1);
        line.startColor = c;
