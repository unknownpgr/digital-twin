...
namespace UnityEngine.AI
{
    ...
    public class NavMeshSurface : MonoBehaviour
    {
        ...
        public void BuildNavMesh(NavMeshBuildSettings _Setting)
        {
            var sources = CollectSources();
            ...
            var data = NavMeshBuilder.BuildNavMeshData(_Setting,
                    sources, sourcesBounds, transform.position, transform.rotation);
        ...
        public AsyncOperation UpdateNavMesh(NavMeshData data, NavMeshBuildSettings setting)
        {
            var sources = CollectSources();
            ...
            return NavMeshBuilder.UpdateNavMeshDataAsync(data, setting, sources, sourcesBounds);
        }
